            ...
            @can('manage_setting')
                <!-- ************** Demo Layouts url ************** -->
                    ...
                    <div class="nav-item {{ ($segment1 == 'rest-api') ? 'active' : '' }}">
                        <a href="{{url('rest-api')}}"><i class="ik ik-cloud"></i><span>{{ __('REST API')}}</span>
                            <span
                    ...
                    <div class="nav-item {{ ($segment1 == 'navbar') ? 'active' : '' }}">
                        <a href="{{url('navbar')}}"><i class="ik ik-menu"></i><span>{{ __('Navigation')}}</span>
                        </a>
                    </div>
                    <div
